...
void main() {
  ...
  group('Pack Loader Tests', () {
    Future<List<String>> fakeAssetListing() async => [
          'assets/packs/test_pack.json',
          'assets/packs/sample_neuro.json',
        ];
    ...
    setUp(() {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
        ...
        if (key == 'assets/packs/sample_neuro.json') {
    ...
    test('loadAllPacks loads valid packs and skips unapproved ones', () async {
      ...
      final packs = await loadAllPacks(approvedCast, listAssetPaths: fakeAssetListing);
